                        ...
                        <div class="content-left">
                            ...
                            <div class="app-store-btn">
                                <a class="store-btn" href="#">
                                    <img src="{{ asset('public/images/play-app.png') }}" alt="Play Store Button">
                                </a>
                                <a class="store-btn" href="#">
                                    <img src="{{ asset('public/images/apple-app.png') }}" alt="Apple Store Button">
                                </a>
                            </div>
                        </div>
                        <div class="content-right">
                            <div class="img-right">
                                <img src="{{ asset('public/images/view-img.png') }}" alt="Mobile View">
                            </div>
                        </div>
                        <div class="bg-shape-one">
                            <img src="{{ asset('public/images/bg-shape.png') }}" alt="Bg shape">
                        </div>
                    </div>
                </div>
            </div>
